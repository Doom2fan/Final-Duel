...
%CMD% -c %SRC%\fd_hlth.ds -o %OBJ%\fd_hlth.o
...
%CMD% %OBJ%\fd_hlth.o %OBJ%\fd_clss.o %OBJ%\fd_misc.o %OBJ%\fd_foot.o %OBJ%\fd_fatl.o %OBJ%\fd_ccmd.o %OBJ%\fd_ccam.o %OBJ%\fd_util.o %OBJ%\fd_main.o -o %OBJ%\main.o
del %OBJ%\fd_hlth.o
del %OBJ%\fd_clss.o
del %OBJ%\fd_misc.o
del %OBJ%\fd_foot.o
