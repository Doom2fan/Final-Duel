...
ACS_NativeDeclFull( 10000, 0, int,    CheckInventoryMax, int);
ACS_NativeDeclFull( 10001, 0, int,    CheckActorInventoryMax, __str, int);
ACS_NativeDeclFull( 10002, 0, int,    SetInventoryMax, __str, int);
